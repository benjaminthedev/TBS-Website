...
/* ============= theme alterations ============================== */
/* change the name of the default options page */

function change_acf_options_name() {
    $new_name = 'Theme Settings';
    if (function_exists('acf_set_options_page_title')) {
        acf_set_options_page_title(__($new_name));
    }
    if (function_exists('acf_set_options_page_menu')) {
        acf_set_options_page_menu(__($new_name));
    }
}

add_action("init", "change_acf_options_name");
...
if( function_exists('acf_add_local_field_group') ):
    ...
    acf_add_local_field_group(array (
        'key' => 'group_589b2cec60f65',
        'title' => 'Contact Details',
        'fields' => array (
            array (
                'key' => 'field_589b2df7bd688',
                'label' => 'Social',
                'name' => '',
                'type' => 'tab',
                'instructions' => '',
            ...
            array (
                'key' => 'field_589b2deebd687',
                'label' => 'Telephone Number Attributes',
                'name' => 'telephone_number_attributes',
                'type' => 'text',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
    ...
    acf_add_local_field_group(array (
        'key' => 'group_589b2cb31bb5b',
        'title' => 'Site Wide Scripts',
        'fields' => array (
            array (
                'key' => 'field_589b2cbd6be9a',
